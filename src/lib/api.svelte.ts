...
export const getDailyInfo = (fetch: Fetch) => fetchTemplate<DailyInfo>(`${base}/daily.json`, fetch);

export async function getDailyLevels(dateKey: string, fetch: Fetch): Promise<Level[] | undefined> {
